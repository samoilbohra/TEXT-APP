...
export default function About(props) {
    ...
    let mystyle  ={
        ...
        color :  props.mode ==='light'? 'black' : 'white' ,
          backgroundColor: props.mode ==='light'? 'white' : '#010d19'} ;
    ...
    return (
        <div >
            <div className='container my-3' style={mystyle}  >
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne">
                            <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" style={mystyle} aria-controls="collapseOne">
                                Accordion Item #1
                            </button>
                        </h2>
                ...
                {/* <button type="button" class={btn} onClick={handleMode} >{mode}</button> */}
            </div>
        </div>
    )
}
